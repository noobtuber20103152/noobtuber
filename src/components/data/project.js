let project = [
    ...
    {
        "title": "Blog website",
        "desc": "This website is built in Next JS. This website includes blogs related to coding , cheat sheets like MongoDB cheat sheet, React js cheat sheet, and a roadmap to become a MERN stack developer.This website also includes a feedback form related to blogs . mongodb is used as a database to store the data. One important thing about this website is that all the blogs fetch the data dynamically from json data and submission of feedback form fill corresponding to each blog.",
        "github": "https://github.com/noobtuber20103152/nextjs-blog",
        "livelink": [false, ""],
        "NextJS": [true, "Next JS"],
        "NodeJS": [true, "NodeJS"],
