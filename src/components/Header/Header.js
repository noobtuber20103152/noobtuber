                            ...
                            <div class="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-0  sm:flex-row flex-col">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <div className='flex flex-row'>
                                        <a target="_blank" href="https://drive.google.com/file/d/1TVNCwToElkWG_JZ3i5X0P9HPVWy219QH/view?usp=sharing" style={{ alignItems: 'center' }} className='hover:text-blue-500 h-11 w-11 hover:bg-blue-100  flex justify-center  rounded-full '>
