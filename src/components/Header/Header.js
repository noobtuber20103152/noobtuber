                        ...
                        <div class="p-4 lg:w-12/12 md:w-full">
                            <div class="flex rounded-lg   p-0  sm:flex-row flex-col">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <p class=" hover:cursor-pointer leading-relaxed text-base">CSE 3rd Year, Quick learner, Self motivated, Enthusiastic</p>
                                    <div className='flex flex-row'>
                                        <a target="_blank" href="https://drive.google.com/file/d/1KnLDvMX4HAgMIMuhsqqAO667EXFgvP7X/view?usp=sharing" style={{ alignItems: 'center' }} className='hover:text-blue-500 h-11 w-11 hover:bg-blue-100  flex justify-center  rounded-full '>
